...
const CarouselBanner = () => {
    const [isHover, setIsHover] = useState(true); // Estado para controlar el autoplay

    return (
        <Carousel
            autoplay={isHover} // Controla el autoplay
            autoplayDelay={5000} // Intervalo de 5 segundos
            loop
            className=" carrusel"
