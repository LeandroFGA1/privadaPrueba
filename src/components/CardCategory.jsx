    ...
    return (
        <div className='w-[40vw] h-[80vh] min-w-[270px] bg-cyan-500 rounded-lg shadow-xl relative group overflow-hidden '>
            ...
            <div className='absolute z-20  bg-gradient-to-b from-transparent   to-black/70 group-hover:bg-black/60 transition-all duration-500 top-0 w-full h-full flex items-center justify-center'>
                <h2 className='capitalize text-3xl  p-4 text-pretty font-semibold relative text-white/80 group-hover:text-white bg-main3/50 group-hover:bg-main transition-all duration-500 rounded-md'>
                    Lorem Lorem
                    <span className='absolute top-0 left-0 w-full h-full '>
                        {/* Línea superior */}
                        <span className='absolute top-0 left-0 w-0 h-[2px] bg-white group-hover:animate-drawTop '></span>
                        {/* Línea lateral izquierda */}
                        <span className='absolute top-0 left-0 w-[2px] h-0 bg-white group-hover:animate-drawSides'></span>
                        {/* Línea lateral derecha */}
                        <span className='absolute top-0 right-0 w-[2px] h-0 bg-white group-hover:animate-drawSides'></span>
                        {/* Línea inferior izquierda */}
                        <span className='absolute bottom-0 left-0 w-0 h-[2px] bg-white group-hover:animate-drawBottom'></span>
                        {/* Línea inferior derecha */}
                        <span className='absolute bottom-0 right-0 w-0 h-[2px] bg-white group-hover:animate-drawBottom'></span>
                    </span>
                </h2>
            </div>
